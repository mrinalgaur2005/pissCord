...
export const ServerSearch = (
    ...
    return(
        <>
            ...
            className="group px-2 py-2 rounder-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 
            dark:hover:bg-zinc-700/50 transition">
                <Search className="w-4 h-4 text-zinc-500 dark:text-zomc-400"/>
                ...
                px-1.5 font-mono text-[10px] font-mdeium text-muted-foreground ml-auto">
                    <span>⌘</span>k
                </kbd>
            </button>
            <CommandDialog
